...
@Service("ProjetoCreditoRuralSupervisaoCreditoRelCh")
public class SupervisaoCreditoRelCh extends _Cadeia {

	@Autowired
	public SupervisaoCreditoRelCh(AutenticarUsuarioCmd c1, SupervisaoCreditoRelCmd c2, LogCmd c3) {
		super.addCommand(c1);
		super.addCommand(c2);
		super.addCommand(c3);
	}

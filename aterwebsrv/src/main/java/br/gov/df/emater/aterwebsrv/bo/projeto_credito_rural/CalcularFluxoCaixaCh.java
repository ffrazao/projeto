...
@Service("ProjetoCreditoRuralCalcularFluxoCaixaCh")
public class CalcularFluxoCaixaCh extends _Cadeia {

	@Autowired
	public CalcularFluxoCaixaCh(AutenticarUsuarioCmd c1, CalcularFluxoCaixaCmd c2, LogCmd c3) {
		super.addCommand(c1);
		super.addCommand(c2);
		super.addCommand(c3);
	}

...
@Service("ProjetoCreditoRuralPlanilhaUploadCh")
public class PlanilhaUploadCh extends _Cadeia {

	@Autowired
	public PlanilhaUploadCh(AutenticarUsuarioCmd c1, PlanilhaUploadCmd c2, LogCmd c3) {
		super.addCommand(c1);
		super.addCommand(c2);
		super.addCommand(c3);
	}

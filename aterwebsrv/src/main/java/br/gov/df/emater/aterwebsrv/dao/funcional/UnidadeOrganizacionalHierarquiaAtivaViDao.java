...
public interface UnidadeOrganizacionalHierarquiaAtivaViDao extends JpaRepository<UnidadeOrganizacionalHierarquiaAtivaVi, Integer> {
	...
	List<UnidadeOrganizacionalHierarquiaAtivaVi> findAllByAscendentePessoaJuridicaOrDescendentePessoaJuridica(PessoaJuridica ascendente, PessoaJuridica descendente);

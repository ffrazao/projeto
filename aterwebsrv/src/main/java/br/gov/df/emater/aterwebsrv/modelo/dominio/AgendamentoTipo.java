...
public enum AgendamentoTipo {
	...
	_0("N�o repetir, � um evento �nico"), _1("Di�riamente"), _2("Todos os dias �teis (Segunda � Sexta-Feira)"), _3("Semanalmente (a cada {0})"), // usar:
																																					// DiaSemana.value(?)
	...
	_7("Anualmente (todo dia {0} de {1})"); // usar: DiaMes.value(?) e
											// Mes.value(?)

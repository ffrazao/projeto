...
@Service("IndiceProducaoBemClassificacaoUtilSrvOld")
public class BemClassificacaoUtilSrvOld {
	...
	public BemClassificacaoCadDto geraMatriz() {
		...
		if (bancoDados != null) {
			for (BemClassificacao bemClassificacao : bancoDados) {
				...
				item.setBemClassificacaoFormaProducaoList(infoBasicaList(item.getBemClassificacaoFormaProducaoList()) );

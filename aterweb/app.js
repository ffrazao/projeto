...
var IDLE_TEMPO = 10 * 60;
var TIMEOUT_TEMPO = 10 * 60;
...
(function(pNmModulo, pNmController, pNmFormulario) {
    ...
    angular.module(pNmModulo, ['ui.bootstrap', 'ui.utils', 'ui.router', 'ngSanitize', 'ngAnimate', 'toastr', 'sticky',
        ...
        'funcionalidade', 'perfil', 'usuario', 'logAcao', 'projetoCreditoRural', 'agenda', 'metaTatica', 'angularUtils.directives.dirPagination',
        ]);
        ...
        function($rootScope, $uibModal, FrzNavegadorParams, toastr, UtilSrv, $stateParams, $timeout, TokenStorage, $state, CestaDeValores, SegurancaSrv, Idle) {
            ...
            $rootScope.visualizar = function(scp, idInf) {
                ...
                if (idInf) {
                    ...
                    if ($stateParams.id) {
                        id = $stateParams.id;
                    } else if (scp.navegador && scp.navegador.selecao) {
                        if (scp.navegador.selecao.tipo === 'U' && scp.navegador.selecao.item) {
...
angular.module(pNmModulo).directive('maxlines', function() {
  return {
    restrict: 'A',
    require: 'ngModel',

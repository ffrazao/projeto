...
angular.module(pNmModulo).controller(pNmController,
    ...
    var init = function() {
        ...
        $scope.pessoaRelacionamentoNvg = new FrzNavegadorParams($scope.cadastro.registro.relacionamentoList, 5);
    };
    ...
    // $scope.seleciona = function(pessoaRelacionamentoNvg, item) { };
    // $scope.mataClick = function(pessoaRelacionamentoNvg, event, item){ };
...
})('pessoa', 'PessoaRelacionamentoCtrl', 'Pessoas vinculado à pessoa');